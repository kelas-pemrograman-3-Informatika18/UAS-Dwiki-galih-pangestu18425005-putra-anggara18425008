<template>
  <q-page padding>
    <div class="q-mb-md">
      ...
      >
        <q-carousel-slide :name="1" img-src="~assets/lampung.jpg" />
        <q-carousel-slide :name="2" img-src="~assets/lampung1.jpg" />
        <q-carousel-slide :name="3" img-src="~assets/lampung2.jpg" />
        <q-carousel-slide :name="4" img-src="~assets/lampung3.jpg" />
      </q-carousel>
    </div>
        ...
        <q-card-section style="max-height: 50vh;" class="scroll">
          ...
          <q-form class="q-mt-md">
            <q-input filled type="number" v-model="jumlah" class="q-mb-md" label="masukkan jumlah"/>
              Rp.{{ total  }},-
            <q-file color="teal" class="q-mt-md" v-model="image" filled label="Bukti Pembayaran Transaksi">
